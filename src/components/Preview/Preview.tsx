    ...
    >
      ...
      <div className="preview__description__container">
        ...
        <div className="grid_container">
          <div><ImKey className="icon"></ImKey></div>
          <div className="preview__eurokey">Eurokey: {place?.eurokey === 0 ? "No" : "Yes"}</div>
        </div>
        <div className="preview__ramp_steepness">Ramp Steepness: {place?.ramp_steepness}</div>
        <div className="preview__door_width">Door Width: {place?.door_width}</div>
